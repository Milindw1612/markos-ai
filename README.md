...
2. **Build capability** — a partial working prototype: four interactive demo modules (illustrative sample data only, no real company figures) and one genuinely functioning n8n automation.
...
demos.html               4 interactive demo panels (Dashboard, ROI/MMM, AI Recommendations, Competitive Intel)
automation/              A real, importable n8n workflow — a daily "Morning Brief" report generator
